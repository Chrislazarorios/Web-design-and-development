...
<body>
	...
	<?php 
		...
		if(!empty($_GET))
		{
			...
			getHTMLTodosLosArticulosPorSeccion($seccion);
		}
		else
		{
...
function DB_getNoticias()
{
	...
	array('1','Noticia 1','Descripcion Noticia 1','t1.png','POLITICA'),
	array('2','Noticia 2','Descripcion Noticia 2','t1.png','POLITICA'),
	array('3','Noticia 3','Descripcion Noticia 3','t1.png','ECONOMIA'),
	array('4','Noticia 4','Descripcion Noticia 4','t1.png','ECONOMIA'),
	array('5','Noticia 5','Descripcion Noticia 5','t1.png','POLICIALES'),
	array('6','Noticia 6','Descripcion Noticia 6','t1.png','ESPECTACULO'),
	array('7','Noticia 7','Descripcion Noticia 7','t1.png','TIEMPO')
...
{
	$articulos = DB_getNoticias($seccionBuscada);
...
{
	$html = '';
	$html = $html . '<form class="columnaMenu" method="get" action="diario.php">';
	$html = $html . '	<input id="'.$id.'" type="submit" name="seccion"  value="'.$nombre.'">';
	$html = $html . '</form>';
	return $html;
}
