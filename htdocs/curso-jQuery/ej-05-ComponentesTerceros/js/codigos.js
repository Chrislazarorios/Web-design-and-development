...
function efectos()
{
	$('.flexslider').flexslider({
		animation : 'slide',
		// direction : 'vertical', // Se anima en sentido vertical 
		// slideShow : false // No se anima automaticamente
		//controlNav : false // Cambia el estilo de navegacion, pueden ser puntos, thumbnails, true para mostrar o false para ocultar
	})
}
